    ...
    def shoot(self):
        ...
        if pos[0] < SCREEN_WIDTH and pos[1] < SCREEN_HEIGHT:
            ...
            if not reload_active and not sprint and self.shoot_cooldown == 0 and self.ammo > 0:
                ...
                print(
                    f'pos[0]: {pos[0]}, pos[1]: {pos[1]} self.rect.centerx: {self.rect.centerx} + (0.75 * self.rect.size[0]: {self.rect.size[0]}), self.direction: {self.direction})')
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        player = Soldier('player', startPos[0] * TILE_SIZE, startPos[1] * TILE_SIZE, 1.65, 5, 20, 5)
                        health_bar = HealthBar(10, 10, player.health, player.health)
                    elif tile == 16:  # create enemies
                        enemy = Soldier('player', 100 * TILE_SIZE, 100 * TILE_SIZE, 1.65, 5, 20, 5)
    ...
    for event in pygame.event.get():
        ...
        # keyboard presses
            ...
            try:
                ...
                start = pygame.math.Vector2(player.rect.centerx + (0.5 * player.rect.size[0] * player.direction),
