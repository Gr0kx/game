...
class Soldier(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        if pos[0] < SCREEN_WIDTH and pos[1] < SCREEN_HEIGHT:
            # update tile value
            if not reload_active and self.shoot_cooldown == 0 and self.ammo > 0:
...
while run:
    ...
    if start_game == False:
        ...
        if player.alive:
            ...
            screen_scroll, level_complete, portal_purple_complete, portal_yellow_complete = player.move(moving_left, moving_right, moving_up, moving_down)
