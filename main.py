    ...
    def move(self, moving_left, moving_right, moving_up, moving_down):
        ...
        if pygame.sprite.spritecollide(self, water_group, False):
            ...
            if bomb_start_time and pygame.sprite.spritecollide(self, water_group, False):
                ...
                if time_since_enter >= 1000 <= 1500:
                    dx_snap = dx
                    dy_snap = dy
                if time_since_enter >= 5000:
                    if dx != dx_snap or dy != dy_snap:
                        self.plant = False
                    else:
                        self.plant = True
                        self.plant_text = 'DEVICE IS ACTIVE'

        if defuser_start and pygame.sprite.spritecollide(self, defuse_group, False):
        ...
        if self.alive and player.alive:
            ...
            if self.vision.colliderect(player.rect):
                ...
                if self.idling == False:
                    ...
                    self.move(ai_moving_left, ai_moving_right, moving_up, moving_down)
...
while run:
    ...
    if start_game == False:
        ...
        if player.alive:
            ...
            screen_scroll, level_complete = player.move(moving_left, moving_right, moving_up, moving_down)
